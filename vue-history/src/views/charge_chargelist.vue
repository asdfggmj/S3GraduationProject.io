          ...
          <el-table-column label="操作" fixed="right" width="400">
            <template #default="scope">
              <el-button-group>
                <el-button
                  type="primary"
                  :disabled="isPyTypeDisabled(scope.row.orderStatus)"
                  @click="pay('现金', scope.row.orderId, scope.row.orderAmount)"
                >
                ...
                <el-button
                  ...
                  type="primary"
                  :disabled="isPyTypeDisabled(scope.row.orderStatus)"
                  @click="pay('支付宝', scope.row.orderId, scope.row.orderAmount)"
                >
