        ...
        <el-row class="mt-10px">
          <el-col>
            <el-table :data="dictData" style="width: 100%" max-height="500" row-key="dictId">
              ...
              <el-table-column label="厂家编号" prop="dictName" width="120" />
              <el-table-column label="厂家名称" prop="dictType" width="200" />
              <el-table-column label="厂家编码" prop="dictType" width="200" />
              <el-table-column label="联系人" prop="dictType" width="200" />
              <el-table-column label="电话" prop="dictType" width="200" />
              <el-table-column label="关键字" prop="dictType" width="200" />
