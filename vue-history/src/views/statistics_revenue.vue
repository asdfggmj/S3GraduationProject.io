    ...
    <el-col>
      <el-card shadow="hover">
        ...
        <el-row justify="space-evenly" style="margin-top: 10px">
          <el-col :span="8">现金: ￥{{ statisticsData.incomeByChannel[0].value.toFixed(2) }}</el-col>
          <!-- <el-col :span="6">微信: 999￥</el-col> -->
          <el-col :span="16">支付宝:￥{{ statisticsData.incomeByChannel[1].value.toFixed(2) }} </el-col>
        ...
        <el-row justify="space-evenly" style="margin-top: 10px">
          <el-col :span="8">现金: ￥{{ statisticsData.refundByChannel[0].value.toFixed(2) }}</el-col>
          <!-- <el-col :span="6">微信: 999￥</el-col> -->
          <el-col :span="16">支付宝: ￥{{ statisticsData.refundByChannel[1].value.toFixed(2) }}</el-col>
          <!-- <el-col :span="6">其他银联: 999￥</el-col> -->
        </el-row>
      </el-card>
    </el-col>
...
const reset = () => {
  ...
  statisticsData.value.income = 0.00;
  statisticsData.value.refund = 0.00;
  statisticsData.value.netIncome = 0.00;
...
const getData = () => {
  //发送后端异步请求
  http.get("statistics/getStatistics",{
    params:{
